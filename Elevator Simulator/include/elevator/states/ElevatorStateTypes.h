...
namespace elevator::states {
    ...
    struct DoorState : core::state::BaseState {
    ...
    inline bool operator==(const DoorState& lhs, const DoorState& rhs) {
        return static_cast<const core::state::BaseState&>(lhs) == static_cast<const core::state::BaseState&>(rhs);
    }
    inline bool operator!=(const DoorState& lhs, const DoorState& rhs) {
        return !(lhs == rhs);
    }
    ...
    struct Heading : core::state::BaseState {
    ...
    struct OperationState : core::state::BaseState {
